<%@ Page Title="Add User - Maintenance Minder" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" CodeBehind="add-user.aspx.cs" Inherits="comp2084_a2_app.add_user" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container" id="add-user">
        <h2><asp:Label ID="add_user_heading" runat="server" Text="Add User"></asp:Label></h2>
        ...
        <div class="form-horizontal col-xs-10 col-sm-6">
            ...
            <div class="form-group text-center">
                <asp:Button ID="save_user" Text="Submit" runat="server" CssClass="btn" OnClick="Save_User" />
            </div>

            <div class="form-group text-center form-msg">
                <asp:Label ID="add_user_msg" runat="server" CssClass="alert alert-danger"></asp:Label>
            </div>
        </div>
    </div>
</asp:Content>
